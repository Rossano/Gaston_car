...
{
  0xee, 0x97, 0xd7, 0x39, 0x78, 0x54, 0x72, 0xb7, 0x7a, 0x44, 0x90, 0xb2, 0x57, 0x3b, 0x22, 0x5a, 
};
GATT_DATA(const sli_bt_gattdb_value_t gattdb_attribute_field_31) = {
  .len = 11,
  .data = { 0x4d, 0x79, 0x20, 0x53, 0x50, 0x50, 0x20, 0x52, 0x65, 0x61, 0x64, }
};
GATT_DATA(const sli_bt_gattdb_value_t gattdb_attribute_field_27) = {
  .len = 12,
  .data = { 0x4d, 0x79, 0x20, 0x53, 0x50, 0x50, 0x20, 0x57, 0x72, 0x69, 0x74, 0x65, }
};
GATT_DATA(const sli_bt_gattdb_value_t gattdb_attribute_field_24) = {
  .len = 16,
  .data = { 0x6a, 0xa6, 0x59, 0xb4, 0x30, 0xc4, 0x29, 0x9c, 0xe6, 0x4b, 0xf5, 0x7e, 0x21, 0xaa, 0x8c, 0x23, }
};
...
GATT_DATA(const sli_bt_gattdb_attribute_t gattdb_attributes_map[]) = {
  ...
  { .handle = 0x1a, .uuid = 0x0002, .permissions = 0x801, .caps = 0xffff, .state = 0x00, .datatype = 0x05, .characteristic = { .properties = 0x0c, .char_uuid = 0x8000 } },
  { .handle = 0x1b, .uuid = 0x8000, .permissions = 0x806, .caps = 0xffff, .state = 0x00, .datatype = 0x07, .dynamicdata = NULL },
  { .handle = 0x1c, .uuid = 0x000a, .permissions = 0x801, .caps = 0xffff, .state = 0x00, .datatype = 0x00, .constdata = &gattdb_attribute_field_27 },
  { .handle = 0x1d, .uuid = 0x0002, .permissions = 0x801, .caps = 0xffff, .state = 0x00, .datatype = 0x05, .characteristic = { .properties = 0x12, .char_uuid = 0x8000 } },
  { .handle = 0x1e, .uuid = 0x8000, .permissions = 0x801, .caps = 0xffff, .state = 0x00, .datatype = 0x07, .dynamicdata = NULL },
  { .handle = 0x1f, .uuid = 0x000e, .permissions = 0x803, .caps = 0xffff, .state = 0x00, .datatype = 0x03, .configdata = { .flags = 0x01, .clientconfig_index = 0x01 } },
  { .handle = 0x20, .uuid = 0x000a, .permissions = 0x801, .caps = 0xffff, .state = 0x00, .datatype = 0x00, .constdata = &gattdb_attribute_field_31 },
};
