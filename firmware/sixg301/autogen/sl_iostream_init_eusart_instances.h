...
extern sl_iostream_t *sl_iostream_mcu_uart_handle;
extern sl_iostream_uart_t *sl_iostream_uart_mcu_uart_handle;
extern sl_iostream_instance_info_t sl_iostream_instance_mcu_uart_info;
...
sl_power_manager_on_isr_exit_t sl_iostream_eusart_mcu_uart_sleep_on_isr_exit(void);
